...
* **[Logi-Code](https://logi-code.com/problems/)**
* **[Latchup](https://www.latchup.app/)**

### 3. Additional references
* **[Digital VLSI Lectures](https://www.youtube.com/playlist?app=desktop&list=PLZU5hLL_713x0_AV_rVbay0pWmED7992G)** 
* **[Computer Architecture Lectures](https://www.youtube.com/playlist?app=desktop&list=PL5Q2soXY2Zi9Eo29LMgKVcaydS7V1zZW3)**
* **[Digital VLSI Course](https://ocw.ece.cornell.edu/ece-4740-course-details)**
* **[FPGA Hardware Acceleration Course](https://people.ece.cornell.edu/land/courses/ece5760/)** 
* **[ChipVerify Tutorials](https://www.chipverify.com/)** 
* **[ZipCPU Blog](https://zipcpu.com/about/)** 

### 4. Simulation & Open-Source Tools
* **[Silicon Space](https://siliconspace.org/docs)**
...
### 5. Advanced Architecture, HPC & AI Hardware
* **[Awesome Open Source Hardware](https://github.com/aolofsson/awesome-opensource-hardware)**
* **[TinyTPU Blog](https://www.tinytpu.com/)**
* **[TPU Architecture Deep Dive](https://henryhmko.github.io/posts/tpu/tpu.html)**
* **[JAX LLM Scaling Book](https://jax-ml.github.io/scaling-book/)** – Guide to scaling LLMs, and its hardware implications
* **[Domain-Specific Architectures for AI](https://fleetwood.dev/posts/domain-specific-architectures#google-tpu)**
* **[HFT Accelerator Report](https://web.mit.edu/6.111/volume2/www/f2019/projects/endrias_Project_Final_Report.pdf)** – HFT FPGA project report sample
